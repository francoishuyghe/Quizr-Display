    ...
    render() {
        ...
        { error.general && 
            ...
            {isSaving
                ...
                : <a onClick={() => this.props.sendEmail(this.state.data)} className="btn">Send my Results{coupons._id && !coupons.discountPausedTradeshow && coupons.discountCodes.length > 0 && " + Discount code"}</a>
            }
      </form>
    }
